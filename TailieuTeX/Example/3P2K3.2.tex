...
\begin{vidu}%[1P5-3.2K][Loai4]
	Một bình kín chứa một lượng khí ở nhiệt độ $25\doC$ và áp suất 3 bar ($1\;bar = 10^5\;Pa$). Phải tăng nhiệt độ lên tới bao nhiêu độ để áp suất tăng gấp ba?
	\choice
	{890 K}
	{621 K}
	{$75\doC$}
...
\begin{vidu}%[1P5-3.2K][Loai5]
	Một bình kín thể tích không đổi chứa khí lí tưởng ở nhiệt độ 27\doC. Biết áp suất ban đầu và sau khi nhiệt độ thay đổi lần lượt là 1 atm và 2,5 atm. Nhiệt độ trong bình tăng thêm một lượng là 
	\choice
	{ 320 K}
	{ \True 450 K}
	{ 350 K}
...
\begin{vidu} %[1P5-3.2B][Loai7]
	immini[thm]{Một khối khí lí tưởng thực hiện hai quá trình như trên hình vẽ. Các thông số được cho trên đồ thị. Biết áp suất của chất khí khi bắt đầu quá trình là 12\ atm. Áp suất của khối khí khi kết thúc quá trình là
		...
		{1,875\ atm}}{\begin{tikzpicture}[scale=1,thick,>=stealth']
			...
			\tkzDrawSegments[blue, very thick,arrow data={0.5}{stealth}](1,2 2,3)
...
\begin{vidu} %[1P5-3.2T][Loai8]
	Một bình đầy không khí ở điều kiện tiêu chuẩn ($0\doC$; $1,013.10^5\ Pa$) được đậy bằng một vật có khối lượng 2\ kg. Tiết diện của miệng bình là $10\ cm^2$.  Biết áp suất khí quyển là $p_0 = 10^5\ Pa$. Lấy $g=10\ m/s^2$. Nhiệt độ lớn nhất của không khí trong bình để không khí không đẩy được nắp bình lên và thoát ra ngoài là
	\choice
	{\True $50,4\doC$}
	{$323,4\doC$}
	{$121,3\doC$}
