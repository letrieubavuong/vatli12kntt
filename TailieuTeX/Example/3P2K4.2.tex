...
\begin{vidu} %[1P5-5.2B][Loai1]
	Một lượng khí đựng trong một xilanh pít-tông chuyển động được. Các thông số trạng thái của lượng khí này là 1,5 atm, 20 lít, $-23^\circ C$. Khi pít-tông nén khí, áp suất của khí tăng lên tới 3 atm, thể tích giảm còn 16 lít. Nhiệt độ của khí nén là
	\choice
	{200 K}
	{100 K}
	{300 K}
...
\end{vidu}
\loai{Xác định các thông số từ đồ thị các không phải đẳng quá trình}
