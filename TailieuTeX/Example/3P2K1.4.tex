...
\begin{vidu}%[1P5-2.3T][Loai4]
	...
	\loigiai{
		...
		\end{align*}
		c) Ống đặt thẳng đứng miệng ống quay lên, nghiêng góc $30^\circ$ ở trạng thái 4:
		\begin{align*}
			V_4=\ell_4S;\ p_4=p_o+\rho \ell_0g \cos{30^\circ}\\
			V_4p_4=V_1p_1 \Rightarrow \ell_4=0,307\ m
		\end{align*}
		d) Ống đặt thẳng đứng miệng ống quay xuống, nghiêng góc $30^\circ$ ở  trạng thái 5
		\begin{align*}
			V_5=\ell_5S;\ p_5=p_o-\rho \ell_0g \cos{30^\circ}\\
			V_5p_5=V_1p_1 \Rightarrow \ell_5=0,43\ m
		\end{align*}
		\begin{note}
			\begin{itemize}
...
\begin{vidu} %[1P5-2.3G][Loai3]
	Một bọt khí nhỏ, nổi lên từ đáy hồ, khi đến mặt nước thì thể tích của nó tăng gấp $1,3$ lần. Biết trọng lượng riêng của nước là $d=10^4\ N/m^3$, áp suất khí quyển là $p_0=10^5\ N/m^2$. Coi nhiệt độ của nước ở các điểm là như nhau.  Độ sâu của đáy hồ là
	\choice
	{4 m}
	{5 m}
	{6 m}
...
\begin{vidu} %[1P5-2.3G][Loai 5]
	Một lượng không khí có thể tích $240\ cm^3$ bị giam trong một xi lanh đặt nằm ngang có pit-tông đóng kín, diện tích của pit-tông là $24\ cm^2$. Áp suất khí trong xi lanh bằng áp suất ngoài là 100 kPa. Bỏ qua ma sát giữa pit-tông và thành xi lanh. Coi quá trình xảy ra là đẳng nhiệt. Cần một lực bằng bao nhiêu để di chuyển pit-tông một đoạn 2 cm theo chiều nén khí? 
	\choice
	{\True 60 N}
	{40 N}
	{20 N}
